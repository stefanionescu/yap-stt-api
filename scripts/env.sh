...
export PARAKEET_ENABLE_PUNCT_CAPIT=${PARAKEET_ENABLE_PUNCT_CAPIT:-1}
export PARAKEET_PUNCT_CAPIT_MODEL_ID=${PARAKEET_PUNCT_CAPIT_MODEL_ID:-nvidia/punctuate_capitalize_english_v1.0}
