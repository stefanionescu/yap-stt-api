...
export PARAKEET_FINALS_TIMEOUT_S=${PARAKEET_FINALS_TIMEOUT_S:-20}
...
export PARAKEET_STREAM_CONTEXT_SECONDS=${PARAKEET_STREAM_CONTEXT_SECONDS:-4}
export PARAKEET_STREAM_TICK_TIMEOUT_S=${PARAKEET_STREAM_TICK_TIMEOUT_S:-1.0}
