...
# Segmented one-shot client policy (documented; not server-enforced)
export PARAKEET_SEGMENT_LEN_MS=${PARAKEET_SEGMENT_LEN_MS:-2200}
export PARAKEET_SEGMENT_MIN_MS=${PARAKEET_SEGMENT_MIN_MS:-1200}
export PARAKEET_SEGMENT_OVERLAP_MS=${PARAKEET_SEGMENT_OVERLAP_MS:-200}
