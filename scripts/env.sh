...
export PARAKEET_MICROBATCH_FINALS_WINDOW_MS=${PARAKEET_MICROBATCH_FINALS_WINDOW_MS:-2}
export PARAKEET_FINALS_QUEUE_MAX_FACTOR=${PARAKEET_FINALS_QUEUE_MAX_FACTOR:-16}
export PARAKEET_FINALS_TIMEOUT_S=${PARAKEET_FINALS_TIMEOUT_S:-5.0}
...
export PARAKEET_STREAM_STEP_MS=${PARAKEET_STREAM_STEP_MS:-320}
export PARAKEET_STREAM_CONTEXT_SECONDS=${PARAKEET_STREAM_CONTEXT_SECONDS:-3}
export PARAKEET_STREAM_TICK_TIMEOUT_S=${PARAKEET_STREAM_TICK_TIMEOUT_S:-0.4}
export PARAKEET_STREAM_HOT_QUEUE_FRACTION=${PARAKEET_STREAM_HOT_QUEUE_FRACTION:-0.5}
export PARAKEET_STREAM_DECIMATION_MIN_INTERVAL_MS=${PARAKEET_STREAM_DECIMATION_MIN_INTERVAL_MS:-300}
...
export PARAKEET_VAD_ENABLE=${PARAKEET_VAD_ENABLE:-0}
...
export PARAKEET_EAGER_SIL_MS=${PARAKEET_EAGER_SIL_MS:-500}
